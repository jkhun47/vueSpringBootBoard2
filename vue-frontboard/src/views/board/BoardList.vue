<template>
    <div class="board-list">
        <div class="common-buttons">
            <button type="button" class="w3-button w3-blue-gray" v-on:click="fnWrite">등록</button>
        </div>
    ...
    methods: {
        fnGetList() {
            ...
            this.$axios.get(this.$serverUrl + "/board/list", {
                ...
                // this.list = res.data
                // console.log("res.data.result_code === 'OK'111" + ('%o',res.data));
                if(res.data.result_code === "OK"){
                    // console.log("res.data.result_code === 'OK'222");
